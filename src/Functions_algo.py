def Extremas(l) :
    """
    Trouve les extrémas d'une série (minimums + maximums locaux) et les indices auxqules ils sont atteints'
    l: sera notre série (cours de bourse ou RSI)
    """
...
def Creation_rsi(dataDF) :
    """
    A partir du cours, Cette fonction crée une data frame contenant la RSI  
    h: est le pas de temps utilisé (h=14 par défaut)
    dataFrame: Data Frame contenant le cours
    
    On utilise ici des fonctions encapsulées
    """
